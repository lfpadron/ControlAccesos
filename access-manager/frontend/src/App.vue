  ...
  <div v-else class="app-shell">
    <aside class="sidebar">
      ...
      <nav>
        ...
        <RouterLink to="/instituciones" @click="clearLocation">Instituciones</RouterLink>
        <RouterLink to="/complejos" @click="clearCampus">Campus</RouterLink>
        <RouterLink to="/torres" @click="clearTower">Torres</RouterLink>
        <RouterLink to="/pisos" @click="clearFloor">Pisos</RouterLink>
